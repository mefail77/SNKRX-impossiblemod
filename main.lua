...
function init()
  ...
  character_descriptions = {
    ...
    ['necromancer'] = function(lvl) return '[fg]deals [yellow]'..1.5*get_character_stat('necromancer', lvl, 'dmg')..'[fg] damage to a random ally and spawns [yellow]1[fg] large critter' end,
  ...
  character_effect_descriptions = {
	...
	['rocketeer'] = function() return "[yellow]+50%[fg] area size upon a crit" end,
	['initiate'] = function() return "[fg]the initiate gains [yellow]+1%[fg] damage every attack" end,
	['necromancer'] = function() return "[fg]spawns [yellow]1[fg] small critter when an unit takes damage. [yellow]1[fg] second cooldown per unit" end,
  ...
  character_effect_descriptions_gray = {
	...
	['rocketeer'] = function() return "[light_bg]+50% area size upon a crit" end,
	['initiate'] = function() return "[light_bg]the initiate gains +1% damage every attack" end,
	['necromancer'] = function() return "[light_bg]spawns 1 small critter when an unit takes damage. 1 second cooldown per unit" end,
  ...
  class_stat_multipliers = {
    ...
    ['cultist'] = {hp = 1.15, dmg = 1.05, aspd = 0.75, area_dmg = 1, area_size = 1, def = 0.95, mvspd = 0.95},
  ...
  tier_to_characters = {
    [1] = {'vagrant', 'swordsman', 'magician', 'archer', 'scout', 'cleric', 'arcanist', 'merchant', 'adventurer', 'sylph', 'host', 'initiate'},
    [2] = {'wizard', 'bomber', 'sage', 'squire', 'dual_gunner', 'sentry', 'chronomancer', 'barbarian', 'cryomancer', 'beastmaster', 'jester', 'carver', 'psychic', 'witch', 'silencer', 'outlaw', 'miner', 'brawler', 'launcher', 'boomerang', 'rocketeer',
	'necromancer', 'acolyte'},
