...
function MainMenu:on_enter(from)
  ...
  self.title_text = Text({{text = '[wavy_mid, fg]oh no', font = fat_font, alignment = 'center'}}, global_text_tags)
  self.title_text2 = Text({{text = "[wavy_mid, green]good luck", font = pixul_font, alignment = 'center'}}, global_text_tags)
  self.title_text3 = Text({{text = "[wavy_mid, purple]lmao", font = pixul_font, alignment = 'center'}}, global_text_tags)

  self.arena_run_button = Button{group = self.main_ui, x = 55, y = gh/2 - 10, force_update = true, button_text = 'time to die', fg_color = 'bg10', bg_color = 'bg', action = function(b)
  ...
  self.options_button = Button{group = self.main_ui, x = 47, y = gh/2 + 12, force_update = true, button_text = 'mess around', fg_color = 'bg10', bg_color = 'bg', action = function(b)
  ...
  self.quit_button = Button{group = self.main_ui, x = 37, y = gh/2 + 34, force_update = true, button_text = 'go byebye', fg_color = 'bg10', bg_color = 'bg', action = function(b)
    system.save_state()
    love.event.quit()
  end}
  self.t:every(2, function() self.soundtrack_button.spring:pull(0.025, 200, 10) end)
  self.soundtrack_button = Button{group = self.main_ui, x = gw - 72, y = gh - 40, force_update = true, button_text = 'dont press me', fg_color = 'bg10', bg_color = 'bg', action = function(b)
    ui_switch2:play{pitch = random:float(0.95, 1.05), volume = 0.5}
  ...
  self.discord_button = Button{group = self.main_ui, x = gw - 92, y = gh - 17, force_update = true, button_text = 'contact despacit2po', fg_color = 'bg10', bg_color = 'bg', action = function(b)
    ui_switch2:play{pitch = random:float(0.95, 1.05), volume = 0.5}
    b.spring:pull(0.2, 200, 10)
    b.selected = true
    ui_switch1:play{pitch = random:float(0.95, 1.05), volume = 0.5}
  ...
  self.discord_button2 = Button{group = self.main_ui, x = gw - 79, y = 17, force_update = true, button_text = 'right here', fg_color = 'bg10', bg_color = 'bg', action = function(b)
    ui_switch2:play{pitch = random:float(0.95, 1.05), volume = 0.5}
    b.spring:pull(0.2, 200, 10)
    b.selected = true
    ui_switch1:play{pitch = random:float(0.95, 1.05), volume = 0.5}
